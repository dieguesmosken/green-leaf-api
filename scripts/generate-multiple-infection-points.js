...
// Configurações para as cidades
const cities = [
  { name: 'Iguape', coordinates: { lat: -24.70806, lng: -47.55528 } },
  { name: 'Pariquera-Açu', coordinates: { lat: -24.715, lng: -47.88111 } },
];
const radius = 0.2; // Raio de 20 km
const pointsPerCity = 500;
...
console.log(`${pointsPerCity * cities.length} pontos de infecção adicionados às cidades especificadas.`);
